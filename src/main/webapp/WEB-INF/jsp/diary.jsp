...
<div>
    <a class="navbar-brand" href="/new_entry/${blog_id}">New</a>
    <div class="container">
            ...
            <c:forEach items="${entries}" var="element">
                ...
                <div class="panel">
                    ...
                    <div class="panel-footer">
                        ...
                        <span>
                                <a href="/new_entry/${element.blog_id}" data-original-title="Edit this entry" data-toggle="tooltip" type="button" class="btn btn-sm btn-primary">New</a>
